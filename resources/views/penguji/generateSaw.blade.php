...
<div class="container-fluid">
    ...
    <div class="selection-card">
        <form method="GET" action="{{ route('generate.page') }}">
            <label>
    ...
    @if ($selectedSeleksi)
        <div class="info-card d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <form action="{{ route('saw.generate', $selectedSeleksi->id) }}"
                    method="POST"
                ...
                <button
                    ...
                    data-url="{{ route('saw.export.pdf', $selectedSeleksi->id) }}">
                    <i class="fas fa-file-pdf me-2"></i>
                    Export Ranking SAW (PDF)
                </button>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.btn-export-pdf').forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            Swal.fire({
                title: 'Generate PDF Ranking?',
                text: 'Pastikan data SAW sudah benar sebelum diexport.',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: 'Ya, Generate',
                cancelButtonText: 'Batal',
