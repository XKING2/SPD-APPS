        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('createTPU') }}" class="btn btn-success">
                    ...
                    <table class="table table-bordered table-hover align-middle">
                        ...
                        @forelse ($questions as $index => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('TPU.edit', Hashids::encode($item->id)) }}"
                                       class="btn btn-sm btn-success btn-edit-orb"
                                        data-url="{{ route('TPU.edit', Hashids::encode($item->id)) }}">
